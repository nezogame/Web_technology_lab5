                            ...
                            <span class="count">
                                <?php
                                    ...
                                    if (!empty($email) && !empty($name)) {
                                        $query = "SELECT sum(quantity) as cart_count FROM cart WHERE user_id = (SELECT id 
                                                  from users 
    ...
    <form class="reg_form" action="registration.php" method="POST" onsubmit="FormValidation(event)" >
        ...
        <form class="account_form"  >
            <div class="account_popup">
                <div class="account_close_button">&times;</div>
                <h1 class="account_heder">Account</h1>
                
                <div class="input-row ">
                  <div class="textarea greeting">hi artur</div>
                </div>
                <div class="input-row ">
                  <div class="textarea user_email">your email</div>
                </div>
                <div class="input-row">
                    <div class ="textarea log_out_validation">Do you want to log out?</div>
                </div>
                
                <div class="button_wrapper">
                  <button class="log_out" onclick="window.location.href='index.php'">Log Out</button>

                  <button class="account_canel" >No</button>
                </div>
            </div>
        </form>
